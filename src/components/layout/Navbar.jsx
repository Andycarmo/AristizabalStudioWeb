    ...
    <nav className="fixed top-0 left-0 w-full bg-gradient-to-r from-studio-green/80 to-studio-green/60 backdrop-blur-md text-studio-pink px-6 py-4 shadow-md z-50 border-b border-white/10">
            ...
            {/* MENU MOBILE (*/}
                            ...
                            >
                              ...
                              <NavLink to="/tienda" onClick={() => setMenuOpen(false)}>Store</NavLink>
                    ...
                    <div className="flex flex-col items-center justify-center z-[60] flex-1">
                              ...
                              <h1 className="title-emboss font-cocomat text-2xl sm:text-3xl md:text-4xl lg:text-5xl tracking-wide text-center">
                                Aristizabal Studio
                                    ...
                                    {/* MENÚ DE NAVEGACIÓN */}
                                  <div className="hidden md:flex gap-8 mt-2 text-sm md:text-base">
                ...
                <div className="hidden md:flex items-center gap-6 z-10">  
                        ...
                        <a href="https://www.youtube.com/@aristizabalstudio" 
                           target="_blank"
                        ...
                        <a href="https://www.tiktok.com/@aristizabal.studio"
                           target="_blank"
                           rel="noopener noreferrer"
                           className="group">
