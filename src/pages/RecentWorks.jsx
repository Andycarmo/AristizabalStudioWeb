...
const artworks = [
  ...
  { id: 15, title: "Zorro", category: "miscelaneos", price: 150, image: "/gallery/obras/miscelaneous/animal-01.webp"},
  ...
  { id: 18, title: "Oso", category: "miscelaneos", price: 150, image: "/gallery/obras/miscelaneous/animal-02.webp"},
  ...
  { id: 23, title: "Buho", category: "miscelaneos", price: 500, image: "/gallery/obras/miscelaneous/animal-03.webp",},
  ...
  { id: 27, title: "Dino", category: "miscelaneos", price: 500, image: "/gallery/obras/miscelaneous/animal-04.webp",},
  ...
  { id: 30, title: "Venado", category: "miscelaneos", price: 500, image: "/gallery/obras/miscelaneous/animal-05.webp",},
  { id: 31, title: "Tulipanes", category: "flores", price: 150, image: "/gallery/obras/flores/flower-02.webp"},
  { id: 32, title: "Ardilla", category: "miscelaneos", price: 150, image: "/gallery/obras/miscelaneous/animal-06.webp"},
  { id: 33, title: "Flores Caballete", category: "flores", price: 150, image: "/gallery/obras/flores/flower-03.webp"},
  { id: 34, title: "Manos y Orquedea", category: "miscelaneos", price: 150, image: "/gallery/obras/miscelaneous/Manos con orquidea sketch grande.webp"},
  { id: 35, title: "Pinturas", category: "flores", price: 150, image: "/gallery/obras/flores/flower-04.webp"},
  { id: 36, title: "Mujer y Ave", category: "miscelaneos", price: 500, image: "/gallery/obras/miscelaneous/Mujer con Ave en lapiz sketch grande.webp",},
  { id: 37, title: "Background", category: "flores", price: 150, image: "/gallery/obras/flores/flower-05.webp"},
  { id: 38, title: "Mujer y flores color", category: "miscelaneos", price: 150, image: "/gallery/obras/miscelaneous/Mujer y Flores lapiz de color sketch.webp"},
    ...
    <div className="min-h-screen flex flex-col bg-[#e9dfd8] text-studio-green pt-18 md:pt-24">
      ...
      <main className="flex-1 px-6 py-12 max-w-7xl mx-auto">
        ...
        <h1 className="font-cocomat text-4xl md:text-5xl mb-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-10">
            {["all", "flores", "aves", "peces", "miscelaneos"].map((cat) => (
              <button
                key={cat}
